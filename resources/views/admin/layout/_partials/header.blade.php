<header class="main-header">
    <a href="{{ action('Admin\DashboardController@index') }}" class="logo"><b>DiPlinth</b></a>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            ...
                            <div class="pull-right">
                                <a href="{{ action('Admin\Auth\LoginController@logout') }}" class="btn btn-default btn-flat">Выход</a>
                            </div>
                        </li>
                    </ul>
                </li>

...
@include('admin.layout._partials.breadcrumbs', [
            ...
            'items' => [
                    ...
                    [ 'title' => 'Список пользователей (администраторов)', 'action' => 'Admin\Auth\RegisterController@getList', 'active' => FALSE ],
...
<div class="box">
    ...
    <div class="box-footer">
        <a href="{{ route('admin.users.index') }}">Назад ко всем пользователям</a>
    </div><!-- /.box-footer-->
</div><!-- /.box -->
@stop